...
export default function Register() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0d0d14] text-white relative overflow-x-hidden flex flex-col">
      ...
      <main className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-center gap-16 px-6 py-10">
        ...
        {/* Left: promo text (large screens only) */}
        <div className="hidden lg:flex flex-col max-w-sm">
          ...
          <div className="mt-10 rounded-2xl border border-violet-500/20 bg-gradient-to-br from-violet-500/10 to-purple-600/5 p-5 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-white/80 text-sm font-semibold">Hoàn toàn miễn phí</span>
            </div>
            <p className="text-white/40 text-xs leading-relaxed">
              Đăng ký miễn phí, không cần thẻ tín dụng. Dữ liệu của bạn được bảo mật an toàn.
            </p>
          </div>
        </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl p-8 shadow-2xl shadow-black/40">
            ...
            <div className="mb-7">
              ...
              <p className="text-white/40 text-sm">
                Đã có tài khoản?{' '}
                <Link to="/" className="text-violet-400 hover:text-violet-300 transition-colors duration-200">
                  Đăng nhập
                </Link>
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Username */}
              <div>
                <label className="block text-white/60 text-xs mb-1.5 ml-0.5">Tên người dùng</label>
                <input
                  type="text"
              ...
              <div className="flex items-start gap-2.5 pt-1">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 rounded border-white/20 bg-white/5 accent-violet-500 cursor-pointer flex-shrink-0"
                />
