...
function EyeOpenIcon({ onClick, visible }) {
  return (
    <svg
      onClick={onClick}
      className={`h-4 text-purple-700 cursor-pointer ${visible ? 'block' : 'hidden'}`}
      fill="none"
...
function EyeSlashIcon({ onClick, visible }) {
  return (
    <svg
      onClick={onClick}
      className={`h-4 text-purple-700 cursor-pointer ${visible ? 'block' : 'hidden'}`}
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                <div className="flex items-center absolute inset-y-0 right-0 mr-3 text-sm leading-5">
                  ...
                  <EyeSlashIcon onClick={() => setShowPassword(!showPassword)} visible={showPassword} />
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="flex items-center absolute inset-y-0 right-0 mr-3 text-sm leading-5">
                  ...
                  <EyeSlashIcon onClick={() => setShowConfirm(!showConfirm)} visible={showConfirm} />
                </div>
              </div>
